...
function () {
  function Attributes(data) {
    ...
    this.set = function (update) {
      _this.data = Object.assign({}, _this.data, __assign({}, update));
    };
...
(function (EventName) {
  ...
  EventName["saveSuccess"] = "saveSuccess";
  EventName["saveError"] = "saveError";
})(EventName || (EventName = {}));
...
function () {
  function Eventing() {
    ...
    this.on = function (eventName, callback) {
      _this.eventHandlers[eventName] = _this.eventHandlers[eventName] || [];

      _this.eventHandlers[eventName].push(callback);
    };
    ...
    this.trigger = function (eventName) {
      ...
      handlers.forEach(function (eventCallback) {
        eventCallback();
      });
    };
  }
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/apis/server.api.ts":[function(require,module,exports) {
"use strict";
...
var server_api_1 = require("../apis/server.api");
...
function () {
  function Sync(baseURL) {
    ...
    this.fetch = function (id) {
      return server_api_1.serverAPI.get(_this.baseURL + "/" + id);
    };
    ...
    this.save = function (data) {
      ...
      if (id) {
        return server_api_1.serverAPI.put(_this.baseURL + "/" + id, data);
      } else {
        return server_api_1.serverAPI.post(_this.baseURL, data);
      }
    };
  }
...
exports.Sync = Sync;
},{"../apis/server.api":"src/apis/server.api.ts"}],"src/models/User.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function User(userData) {
    ...
    this.sync = new Sync_1.Sync("users");
    this.attributes = new Attributes_1.Attributes(userData);
  }
